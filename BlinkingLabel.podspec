...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/vinod-maralad/BlinkingLabel"

  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Vinod Maralad" => "vinod.maralad@outlook.com" }
  s.source           = { :git => "https://github.com/vinod-maralad/BlinkingLabel.git", :tag => s.version.to_s }
